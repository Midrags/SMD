...
def main(ui: UI, args: argparse.Namespace) -> MainReturnCode:
    ...
    patch_steam_opt = getattr(MainMenu, "PATCH_STEAM", None)
    if patch_steam_opt and menu_choice == patch_steam_opt:
        return ui.steam_patch_menu()
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
                        ...
                        epilog='For more information, visit: https://github.com/jericjan/smd')
    parser.add_argument(
    ...
    # Handle --version flag
    if args.version:
        print(f"SMD (Steam Manifest Downloader) version {VERSION}")
        sys.exit(0)
