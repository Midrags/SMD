...
SMD helps you set up games to work with Steam using Lua files and related data. It writes the right files into your Steam folder so games can run. It does not replace or crack Steam itself.

**What you need before using SMD**

- Steam installed.  
- GreenLuma — you need to download and set it up yourself. See the [Setup Guide](SETUP_GUIDE.md) for the download link and steps.  
- A Lua file for the game (or use SMD to download one).  
...
SMD is the main tool. Midrags – for this build and distribution. The DLC Unlockers feature uses ideas and compatibility from CreamInstaller. Use SMD at your own responsibility.
